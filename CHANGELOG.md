# Godyar CMS v1.25.0-beta
Release date: 2026-02-02

## Highlights
- Added **Admin 2FA (TOTP)** with **backup codes** and a dedicated admin UI to enable/disable and rotate recovery codes.
- Added developer + contributor documentation set (installation, architecture, security, coding standards, plugins, API).
- Added a ready-to-import **GitHub roadmap** file with milestones and issue lists for v1.25.

## Security
- Admin 2FA (TOTP) with backup codes, plus rate limiting on the verification step.
- Session rotation after successful 2FA verification.

## Maintenance
- Added v1.25 release notes and an operational checklist for rolling out 2FA.
