...
render_page(__('t_fa678d5458', 'قاعدة البيانات'),'/admin/db', function(){ ?>
  <div class="card p-3"><h1 class="h5 mb-3"><svg class="gdy-icon me-2" aria-hidden="true" focusable="false"><use href="#more-h"></use></svg> <?= h(__('t_f63664d6dc', 'عمليات قاعدة البيانات')) ?></h1>
