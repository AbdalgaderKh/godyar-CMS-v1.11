...
<main class="main-content gdy-elections-edit admin-content  py-4 ">
  ...
  <div class="page-inner ">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
      <div>
        <h1 class="h4 mb-1"><?php echo h(__('t_c948642bb2', 'تعديل تغطية انتخابية')); ?></h1>
        <p class="mb-0 small text-muted">
          <?php echo h(__('t_626349504b', 'تعديل البيانات الأساسية للتغطية الانتخابية، حالة العرض، وعدد المقاعد/الأغلبية.')); ?>
        </p>
      </div>
      <div class="d-flex flex-wrap gap-2">
        <?php if ($slug !== ''): ?>
          <a href="/elections.php?election=<?php echo rawurlencode($slug); ?>"
             target="_blank"
             class="btn btn-sm btn-outline-info">
            <svg class="gdy-icon" aria-hidden="true" focusable="false"><use href="#more-h"></use></svg>
            <?php echo h(__('t_9c30b1d339', 'عرض التغطية على الموقع')); ?>
          </a>
        <?php endif; ?>
    ...
    <div class="row g-3">
      ...
      <div class="col-lg-8">
        <div class="card shadow-sm">
          <div class="card-header">
            <span class="fw-semibold small"><?php echo h(__('t_abc48cf5b4', 'بيانات التغطية الانتخابية')); ?></span>
          </div>
          <div class="card-body">
            <form method="post">
              ...
              <div class="mb-3">
                ...
                <div class="form-text">
                  <?php echo h(__('t_1e24b2e0f7', 'مثال: الانتخابات العامة 2025 – المجلس التشريعي.')); ?>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <div class="form-text">
                  <?php echo h(__('t_519640d9e0', 'يُستخدم في عنوان الرابط:')); ?> <code>/elections.php?election=slug</code> <?php echo h(__('t_33e28f5d57', '–
              ...
              <div class="mb-3">
                ...
                <textarea name="description"
                          rows="3"
                          class="form-control form-control-sm"><?php echo h($description); ?></textarea>
                <div class="form-text">
                  <?php echo h(__('t_f0e07b81f0', 'وصف قصير عن نوع الانتخابات، النطاق الجغرافي، أو أي ملاحظات تساعد فريق التحرير.')); ?>
                </div>
              </div>
              ...
              <div class="row g-3 mb-3">
                <div class="col-md-4">
                  ...
                  <select name="status" class="form-select form-select-sm">
                    ...
                    <option value="hidden"   <?php echo $status === 'hidden'   ? 'selected' : ''; ?>><?php echo h(__('t_dabfd20743', 'مخفي (للتحضير)')); ?></option>
                    <option value="archived" <?php echo $status === 'archived' ? 'selected' : ''; ?>><?php echo h(__('t_ddfda53ee7', 'أرشيف (منتهية)')); ?></option>
                  </select>
                </div>
                <div class="col-md-4">
                  <label class="form-label"><?php echo h(__('t_2b007aa4a7', 'إجمالي المقاعد / الدوائر')); ?></label>
                  <input type="number"
                         name="total_seats"
                         min="0"
                         class="form-control form-control-sm"
                         value="<?php echo $totalSeats !== null ? (int)$totalSeats : ''; ?>">
                  <div class="form-text">
                    <?php echo h(__('t_b429fca82c', 'عدد المقاعد أو الدوائر الكلي في هذه التغطية (اختياري ولكن يُفضّل تعبئته).')); ?>
                  </div>
                </div>
                <div class="col-md-4">
                  <label class="form-label"><?php echo h(__('t_99e286602e', 'مقاعد الأغلبية')); ?></label>
                  <input type="number"
                         name="majority_seats"
                         min="0"
                         class="form-control form-control-sm"
                         value="<?php echo $majoritySeats !== null ? (int)$majoritySeats : ''; ?>">
                  <div class="form-text">
                    <?php echo h(__('t_07fe670437', 'الحد الأدنى من المقاعد المطلوبة لتشكيل أغلبية (إن وجد).')); ?>
                  </div>
                </div>
              </div>

              <button type="submit" class="btn btn-primary">
                <svg class="gdy-icon me-1" aria-hidden="true" focusable="false"><use href="#save"></use></svg> <?php echo h(__('t_02f31ae27c', 'حفظ التغييرات')); ?>
              </button>
              <a href="index.php" class="btn btn-link text-muted">
                <?php echo h(__('t_7b0171f92b', 'إلغاء والرجوع للقائمة')); ?>
              </a>
            </form>
          </div>
        </div>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm mb-3">
          <div class="card-header">
            <span class="fw-semibold small"><?php echo h(__('t_d92dfacf66', 'لمحة سريعة عن التغطية')); ?></span>
          </div>
          <div class="card-body small">
            <p class="mb-1">
              <span class="text-muted"><?php echo h(__('t_0cce68b871', 'المعرّف الداخلي (ID):')); ?></span>
              <span class="badge-soft-muted"><?php echo (int)$id; ?></span>
            </p>
            <p class="mb-1">
              <span class="text-muted"><?php echo h(__('t_477cd86663', 'حالة العرض الحالية:')); ?></span>
            ...
            <p class="mb-1">
              <span class="text-muted"><?php echo h(__('t_d509038ed1', 'إجمالي المقاعد / الدوائر:')); ?></span>
              <strong><?php echo $totalSeats !== null ? (int)$totalSeats : __('t_cd09c30d57', 'غير محدد'); ?></strong>
            </p>
            <p class="mb-0">
              <span class="text-muted"><?php echo h(__('t_f3fe7e116c', 'مقاعد الأغلبية:')); ?></span>
              <strong><?php echo $majoritySeats !== null ? (int)$majoritySeats : __('t_cd09c30d57', 'غير محدد'); ?></strong>
            </p>
            <hr>
            <p class="text-muted mb-1">
              <?php echo h(__('t_d6595bb629', 'بعد حفظ التغييرات يمكنك إدارة:')); ?>
            </p>
            <ul class="small mb-0 ps-3">
              <li><?php echo h(__('t_b9ea4fb2f2', 'الولايات / المناطق من صفحة')); ?> <a href="regions.php?election_id=<?php echo (int)$id; ?>"><?php echo h(__('t_099b8cbd63', 'الولايات')); ?></a></li>
              <li><?php echo h(__('t_ae19d650d1', 'الأحزاب من صفحة')); ?> <a href="parties.php?election_id=<?php echo (int)$id; ?>"><?php echo h(__('t_ccaed8db11', 'الأحزاب')); ?></a></li>
              <li><?php echo h(__('t_ba99692b30', 'النتائج من صفحة')); ?> <a href="results.php?election_id=<?php echo (int)$id; ?>"><?php echo h(__('t_5f115f7184', 'النتائج')); ?></a></li>
            </ul>
          </div>
        </div>
      </div>
