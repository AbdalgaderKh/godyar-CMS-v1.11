...
<head>
    ...
    <link rel="stylesheet" href="<?php echo h($adminBase . '/assets/css/admin-shell.css?v=' . $shellVer); ?><link rel="stylesheet" href="/admin/assets/css/admin-sidebar.css?v=1.0.0">
">
