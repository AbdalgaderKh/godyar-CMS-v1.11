...
$tags_input = '';
try { $tags_input = gdy_get_news_tags($pdo, $id); } catch (Exception $e) { $tags_input = ''; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ضمان التفرد عند التعديل (استثناء نفس الخبر)
...
// بعد نجاح الحفظ: احذف الصورة القديمة إذا تم رفع صورة جديدة
            ...
            catch (Exception $e) { error_log('Error syncing tags: ' . $e->getMessage()); }
...
<div class="admin-content gdy-page">
  <div class="container-fluid">
    <div class="gdy-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
      <div>
        <h1><svg class="gdy-icon" aria-hidden="true" focusable="false"><use href="#edit"></use></svg><?php echo h(__('t_12df53dbfc', 'تعديل الخبر #')); ?><?php echo (int)$id; ?></h1>
