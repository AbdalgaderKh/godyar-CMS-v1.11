...
<?php if ($notice): ?>
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            <label class="form-label"><?php echo h(__('t_2bd584d5c7', 'اسم الموقع')); ?></label>
            <input class="form-control" name="site_name" value="<?php echo h($site_name); ?>">
          </div>

          <div class="mb-3">
            <label class="form-label"><?php echo h(__('t_81edd198f5', 'وصف مختصر')); ?></label>
            <textarea class="form-control" name="site_desc" rows="3"><?php echo h($site_desc); ?></textarea>
          </div>

          <div class="mb-3">
            <label class="form-label"><?php echo h(__('t_cccf89f08f', 'رابط الموقع')); ?></label>
            <input class="form-control" name="site_url" value="<?php echo h($site_url); ?>">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" type="color" name="theme_color" value="<?php echo h($theme_color ?: '#0ea5e9'); ?>" style="max-width:180px">
          <hr>
          ...
          <div class="row g-2 mb-3">
            <div class="col-md-4">
              ...
              <input class="form-control" type="number" name="media_compress_max_width" value="<?php echo (int)$media_compress_max_width; ?>" min="640" max="4096">
            </div>
            <div class="col-md-4">
              <label class="form-label">جودة JPEG/WebP (40-95)</label>
              <input class="form-control" type="number" name="media_compress_quality" value="<?php echo (int)$media_compress_quality; ?>" min="40" max="95">
            </div>
          </div>
          <div class="form-check form-switch mb-2">
          ...
          <div class="row g-2 mb-1">
            <div class="col-md-4">
              ...
              <input class="form-control" type="number" name="media_watermark_opacity" value="<?php echo (int)$media_watermark_opacity; ?>" min="10" max="90">
            </div>
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              <label class="form-label"><?php echo h(__('t_2a1ce89dca', 'بريد التواصل')); ?></label>
              <input class="form-control" type="email" name="site_email" value="<?php echo h($site_email); ?>">
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label"><?php echo h(__('t_0947ad5747', 'رقم الهاتف')); ?></label>
              <input class="form-control" name="site_phone" value="<?php echo h($site_phone); ?>">
            </div>
            <div class="col-md-4 mb-3">
              <label class="form-label"><?php echo h(__('t_6dc6588082', 'العنوان')); ?></label>
              <input class="form-control" name="site_address" value="<?php echo h($site_address); ?>">
            </div>
          </div>
