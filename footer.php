    ...
    <div class="container gdy-footer-inner">
      <div class="gdy-footer-main">
        ...
        <div class="gdy-footer-brand">
          <div class="gdy-footer-title"><?php echo htmlspecialchars((string)$siteName, ENT_QUOTES, 'UTF-8'); ?></div>
          <div class="gdy-footer-tagline">
            <?php echo htmlspecialchars((string)$siteTagline, ENT_QUOTES, 'UTF-8'); ?>
          </div>
        </div>
        ...
        <div class="gdy-footer-contact">
          <?php if ($siteEmail): ?>
            <div><svg class="gdy-icon ms-1" aria-hidden="true" focusable="false"><use href="#mail"></use></svg> <?php echo htmlspecialchars((string)$siteEmail, ENT_QUOTES, 'UTF-8'); ?></div>
          <?php endif; ?>
          <?php if ($sitePhone): ?>
            <div><svg class="gdy-icon ms-1" aria-hidden="true" focusable="false"><use href="#phone"></use></svg> <?php echo htmlspecialchars((string)$sitePhone, ENT_QUOTES, 'UTF-8'); ?></div>
          <?php endif; ?>
          <?php if ($siteAddr): ?>
            <div>
              <svg class="gdy-icon ms-1" aria-hidden="true" focusable="false"><use href="#map"></use></svg>
              <strong><?php echo htmlspecialchars((string)__("address"), ENT_QUOTES, 'UTF-8'); ?>:</strong>
              <?php echo htmlspecialchars((string)$siteAddr, ENT_QUOTES, 'UTF-8'); ?>
            </div>
          <?php endif; ?>
        </div>
      ...
      <div class="gdy-footer-bottom">
        ...
        <span>© <?php echo $year; ?> <?php echo htmlspecialchars((string)$siteName, ENT_QUOTES, 'UTF-8'); ?>. <?php echo htmlspecialchars((string)__("all_rights_reserved"), ENT_QUOTES, 'UTF-8'); ?>.</span>
