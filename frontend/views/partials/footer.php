...
// --- Logo URL (used by footer) ---
$baseUrl = function_exists('base_url') ? rtrim((string)base_url(), '/') : '';
$logoRaw = (string)($siteSettings['site_logo'] ?? '');
$logoUrl = '';
if ($logoRaw !== '') {
  ...
  <style>
    ...
    .gdy-footer-brand__logo{
      ...
      background:
        ...
        radial-gradient(circle at 70% 80%, rgba(var(--primary-rgb), .28), rgba(var(--primary-rgb), 0) 60%),
        rgba(255,255,255,.18);
    ...
    .gdy-footer-brand__logo img{
      width: 72%;
      height: 72%;
      object-fit: contain;
      filter: drop-shadow(0 1px 0 rgba(255,255,255,.35)) drop-shadow(0 10px 14px rgba(0,0,0,.18));
      transform: translateY(-1px);
    }
    .gdy-footer-brand__logo-fallback{
      font-weight: 900;
      font-size: 1.4rem;
      color: rgba(15,23,42,.88);
      text-shadow: 0 1px 0 rgba(255,255,255,.55);
    }
    .gdy-footer-brand__text{ display: inline-flex; flex-direction: column; min-width: 0; }
    ...
    <div class="container gdy-footer-inner">
      <div class="gdy-footer-main">
        ...
        <div class="gdy-footer-brand">
          <a class="gdy-footer-brand__link" href="<?php echo h($baseUrl); ?>/" aria-label="<?php echo h($siteName); ?>">
            ...
            <span class="gdy-footer-brand__text">
              <span class="gdy-footer-title"><?php echo h($siteName); ?></span>
              <span class="gdy-footer-tagline"><?php echo h($siteTagline); ?></span>
            </span>
          </a>
        </div>
...
if ($logoRaw !== '') {
  if (function_exists('gdy_normalize_site_logo_value')) {
    $logoUrl = (string)gdy_normalize_site_logo_value($logoRaw, $baseUrl);
  } else {
    $logoUrl = $logoRaw;
  }
}
