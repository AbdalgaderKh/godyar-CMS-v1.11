 ...
 * @package PHPMailer
 * @author Paulo Henrique Garcia <admin@example.com>
 * @author Lucas Guimarães <admin@example.com>
 * @author Phelipe Alves <admin@example.com>
 * @author Fabio Beneditto <admin@example.com>
 * @author Geidson Benício Coelho <admin@example.com>
 */
